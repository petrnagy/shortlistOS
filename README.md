...
| `WEB_CLIPPER_API_URL`                       | Internal URL of the proprietary Web Clipper API service                   | For Web Clipper                             | `http://127.0.0.1:3010`                                     |
| `WEB_CLIPPER_API_PORT`                      | Port used by the proprietary Web Clipper API service                      | For Web Clipper                             | `3010`                                                      |
| `WEB_CLIPPER_ACCESS_TOKEN_SECRET`           | Secret used to sign short-lived Web Clipper access tokens                 | For Web Clipper                             | Random 32+ character string                                 |
| `WEB_CLIPPER_ENCRYPTION_KEY`                | Secret used to encrypt captured page snapshots                            | For Web Clipper                             | Random 32+ character string                                 |
| `WEB_CLIPPER_ALLOWED_ORIGINS`               | Exact allow-list of browser extension origins                             | For Web Clipper                             | Comma-separated origins                                     |
