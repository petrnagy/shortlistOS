ALTER TABLE "card"
ADD COLUMN "shortlist_dataFetchRequestedBy" uuid;--> statement-breakpoint

ALTER TABLE "shortlist_enrichment_job"
ADD COLUMN "requestedBy" uuid;--> statement-breakpoint

ALTER TABLE "shortlist_provider_request"
ADD COLUMN "accountId" uuid;--> statement-breakpoint
...
WHERE request."sourceJobId" = source_job."id"
  AND request."accountId" IS NULL;--> statement-breakpoint
