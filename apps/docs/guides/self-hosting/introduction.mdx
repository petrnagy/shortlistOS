...
compose](https://github.com/petrnagy/shortlistOS/blob/main/docker-compose.yml) in the
...
<Steps>
  <Step title="Create a docker-compose.yml">
    ...
    services:
      web:
    image: ghcr.io/petrnagy/shortlistos:latest
    ...
    <Tip>
The example above is intentionally minimal. The repository provides a more feature-complete compose file at [docker-compose.yml](https://github.com/petrnagy/shortlistOS/blob/main/docker-compose.yml) if you want environment-based configuration, OAuth, S3, and more.
    </Tip>
...
- [GitHub README](https://github.com/petrnagy/shortlistOS/blob/main/README.md)
- [GitHub docker-compose.yml](https://github.com/petrnagy/shortlistOS/blob/main/docker-compose.yml)
